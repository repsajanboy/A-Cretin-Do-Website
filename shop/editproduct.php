                      ...
                      <div class="jumbotron">
                         <div class="panel panel-info">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="number" name="price" placeholder="product price" required value="<?php echo $row['product_Price'];?>">
                            </div>
                            <div class="form-group">
                                  <label><bold>Product Stock</label>
                                <input class="form-control" type="number" name="stock" placeholder="Stock" required value="<?php echo $row['product_Stock'];?>">
                            </div>
